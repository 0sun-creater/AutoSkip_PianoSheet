...
img_gray = cv2.imread('Images/sen1.png',0)
img_rgb = cv2.imread('Images/sen1.png')
...
flag=1
i=0
first = first_last[i][0]-12
last = first_last[i][1]+15
...
_, img = cv2.threshold(img2, 88, 255, cv2.THRESH_BINARY)
img = 255 - img;
...
def melody(axis_y,first2,last2):
    ...
    if axis_y > (last2 + (3*calcu))-2 and axis_y < (last2 + (3*calcu))+2:
        melody_.append(31)
    elif axis_y > (last2 + (2*calcu))-2 and axis_y < (last2 +(2*calcu))+3:
        melody_.append(32)
    elif axis_y > (last2 + (1*calcu))-2 and axis_y < (last2 +(1*calcu))+2:
        melody_.append(33)
    elif axis_y > (last2)-2 and axis_y < (last2)+3:
        melody_.append(34)
    elif axis_y > (last2 - (1*calcu))-2 and axis_y < (last2 - (1*calcu))+2:
        melody_.append(35)   
    elif axis_y > (last2 - (2*calcu))-2 and axis_y < (last2 - (2*calcu))+3:
        ...
        melody_.append(37)
    elif axis_y > (last2 - (4*calcu))-2 and axis_y < (last2 - (4*calcu))+3:
        melody_.append(38)   
    elif axis_y > (last2 - (5*calcu))-2 and axis_y < (last2 - (5*calcu))+2:
        melody_.append(39)
    elif axis_y > (last2 - (6*calcu))-2 and axis_y < (last2 - (6*calcu))+3:
        melody_.append(40)
    elif axis_y > (last2 - (7*calcu))-2 and axis_y < (last2 - (7*calcu))+2:
        melody_.append(41)
    elif axis_y > (first2)-2 and axis_y < (first2)+3:
        melody_.append(42)
    elif axis_y > (first2 - (1*calcu))-2 and axis_y < (first2- (1*calcu))+2:
        melody_.append(43)
    elif axis_y > (first2 - (2*calcu))-2 and axis_y < (first2 - (2*calcu))+3:
        melody_.append(44)
    elif axis_y > (first2 - (3*calcu))-2 and axis_y < (first2 - (3*calcu))+2:
        melody_.append(45)
    elif axis_y > (first2 - (4*calcu))-2 and axis_y < (first2 - (4*calcu))+3:
        melody_.append(46)
    else:
        melody_.append(100)
...
def melody2(axis_y,first2,last2):
    ...
    if axis_y > (last2 + (3*calcu))-2 and axis_y < (last2 + (3*calcu))+2:
        melody_.append(1)
    elif axis_y > (last2 + (2*calcu))-3 and axis_y < (last2 +(2*calcu))+3:
        melody_.append(2)
    elif axis_y > (last2 + (1*calcu))-2 and axis_y < (last2 +(1*calcu))+1:
        melody_.append(3)
    elif axis_y > (last2)-2 and axis_y < (last2)+3:
        melody_.append(4)
    elif axis_y > (last2 - (1*calcu))-2 and axis_y < (last2 - (1*calcu))+2:
        ...
        melody_.append(6)
    elif axis_y > (last2 - (3*calcu))-3 and axis_y < (last2 - (3*calcu))+2:
        melody_.append(7)
    elif axis_y > (last2 - (4*calcu))-2 and axis_y < (last2 - (4*calcu))+2:
        melody_.append(8)   
    elif axis_y > (last2 - (5*calcu))-3 and axis_y < (last2 - (5*calcu))+2:
        melody_.append(9)
...
for q in range(0,len(all_key),1):
    if (all_key[q]==99999):
        ...
        if first-17 <= all_key[q][1] and last+13 >= all_key[q][1]:
            melody2(all_key[q][1],first,last)
        else :
            melody(all_key[q][1],first2,last2)
