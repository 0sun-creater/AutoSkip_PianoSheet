...
img_gray = cv2.imread('Images/summer1.jpg',0)
img_rgb = cv2.imread('Images/summer1.jpg')
...
_, img = cv2.threshold(img2, 128, 255, cv2.THRESH_BINARY)
img = 255 - img;
...
dic_mel={1:'B4',2:'C5',3:'D5',4:'E5',5:'F5',6:'G5',7:'A5',8:'B5',9:'C6',10:'D6',11:'E6',12:'F6',13:'G6',14:'A6',15:'B6',16:'C7',31:'D3',32:'E3',33:'F3',34:'G3',35:'A3',36:'B3',37:'C4',38:'D4',39:'E4',40:'F4',41:'G4',42:'A4',43:'B4',44:'C5',45:'D5',46:'E5'}
    ...
    if keypoints[i].pt[1] > first and keypoints[i].pt[1] < last:
        ...
        if k% 2==0:
            ...
            for n in range(0,len(right),1):
                if n == len(right)-1:
                    break
                if abs(right[n+1][0] - right[n][0]) < 3 and abs(right[n+1][1] - right[n][1]) < 3:
                    pop_arr.append(n)
                elif n!=0 and abs(right[n+1][0] - right[n-1][0]) < 3 and abs(right[n+1][1] - right[n-1][1]) < 3:
                    pop_arr.append(n-1)
...
for q in range(0,len(all_key),1):
    if (all_key[q]==99999):
        ...
        if first-12 <= all_key[q][1] and last+12 >= all_key[q][1]:
